...
type (
	...
	DeveloperAppStore interface {
		...
		GetByOrganization(organizationName string) ([]shared.DeveloperApp, error)

		// GetByName returns a developer app
		GetByName(organization, developerAppName string) (*shared.DeveloperApp, error)

		// GetByID returns a developer app
		GetByID(organization, developerAppID string) (*shared.DeveloperApp, error)
		...
		UpdateByName(app *shared.DeveloperApp) error
